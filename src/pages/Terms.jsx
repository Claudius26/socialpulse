...
const SECTIONS = [
  ...
  },
  {
    h: "4. The Services",
    body: [
      "SocialPulse provides digital services which may include: temporary virtual phone numbers for receiving SMS one-time passwords (OTP) and verification codes, social media growth (\"boost\") services, VPN & proxy access, airtime & data top-ups, bill payments, gift cards, and wallet funding (including by card, bank transfer and cryptocurrency).",
