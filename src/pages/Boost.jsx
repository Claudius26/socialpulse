        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {platforms.map((p) => (
            <button
              ...
              className={`border rounded-xl p-5 flex items-center gap-3 shadow-sm hover:shadow-md transition w-full ${
        ...
        {selectedCategory && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-white rounded-lg p-4 border border-blue-200 flex justify-between items-center">
              ...
              {insufficientFunds ? (
                <button
                  ...
                  className="w-full bg-yellow-500 text-white py-3 rounded-lg font-semibold hover:bg-yellow-600 transition mt-4"
                >
                  Fund Wallet
                </button>
              ) : (
